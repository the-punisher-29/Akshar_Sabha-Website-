...
const BuyNowButton = styled(PrimaryButtonBase)`
  ${tw`bg-orange-500 rounded-full uppercase tracking-wider py-4 w-full text-sm hover:shadow-xl transform hocus:translate-x-px hocus:-translate-y-px focus:shadow-outline`}
`;
